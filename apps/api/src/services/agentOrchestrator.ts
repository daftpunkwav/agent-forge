...
import type { ProviderConfig } from '../lib/llm/types.js';
...
export async function retryHoverExplain(
 ...
 */
export async function finalizeHoverAnswer(
  provider: ProviderConfig,
  userMsg: string,
  candidate: string,
  onRetry?: () => void,
...
export const HISTORY_TOKEN_BUDGET = { fast: 600, deep: 2000 } as const;
 ...
 */
export function resolveReactEnabled(body: ChatBody): boolean {
...
export function llmError(err: unknown): AppError {
